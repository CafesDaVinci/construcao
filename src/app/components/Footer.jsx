...
import logo1 from "../../../public/LogoPreta.png"
    ...
    return (
        <div>
            <div className="flex flex-col md:flex-row relative">
                <div className="text-center md:px-16 py-10 md:w-1/2 h-96 space-y-5 bg-secondary border-x border-dashed">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center w-screen p-20 text-base bg-text text-primary md:divide-x-2">
                ...
                <div className="h-28 w-64 flex items-center justify-center py-5 px-10 space-x-5"> 
            ...
            <div className=" py-5 text-text flex flex-col items-center justify-center text-center">
                <Image src={logo1} alt="logo pra empresa Café da Vinci"
