    ...
    return (
        <div>
            ...
            <div className="flex justify-center items-center w-screen p-20 text-base bg-bgfooter text-primary">
                <div className="flex justify-center items-center space-x-5 border border-primary py-5 px-10 h-28">
                ...
                <div className="h-28 flex items-center justify-center border-y border-primary py-5 px-10 space-x-5">
                ...
                <div className="h-28 flex items-center justify-center gap-5 border border-primary py-7 px-10">
