    ...
    <div className=" flex flex-col justify-center  items-center w-screen">
      ...
      <div className="w-full flex justify-center md:ml-[500px] mt-5 items-center text-center">
        <motion.p
          ...
          className="text-xl md:text-4xl md:w-[600px] flex justify-end items-end font-bebas"
        >
      ...
      >
        <Image
          src={xicara}
          alt="xicara de café"
          className="w-80 right-72 -top-48 md:absolute"
        />
      </motion.div>
      <div className="flex justify-center items-center w-full md:mr-[250px] my-20">
        <motion.h2
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="uppercase text-5xl md:text-8xl z-10 font-bebas text-secondary drop-shadow-dark1 flex justify-center items-center md:justify-start md:items-start"
        >
          <span className="text-primary mr-2">NOSSAS </span>PAIXÕES
        </motion.h2>
      </div>
      <div className="md:mt-36 md:mr-[550px]">
        <motion.p
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
      ...
      >
        <Image
          ...
          className=" absolute hidden md:blcok"
        />
      </motion.div>
    </div>
  );
